...
def parse_args():
    ...
    parser.add_argument("--word-pause", type=float, default=0.5, help="Seconds between word and example.")
    parser.add_argument("--card-pause", type=float, default=0.5, help="Seconds between cards.")
